...
# Make clean
clean:
	rm -rf "./$(PROGRAM_NAME)" "./gmp-6.3.0.tar.xz" "./gmp-6.3.0" "./gmp" "./mpfr-4.2.1.tar.gz" "./mpfr-4.2.1" "./mpfr" "./openssl-3.1.3.tar.gz" "./openssl-3.1.3" "./openssl" "./libevent-2.2.1-alpha-dev.tar.gz" "./libevent-2.2.1-alpha-dev" "./libevent" "./master.zip" "./secp256k1-zkp-master" "./secp256k1-zkp" "./sqlite-autoconf-3430100.tar.gz" "./sqlite-autoconf-3430100" "./sqlite" "./v3.3.0.zip" "./simdjson-3.3.0" "./simdjson" "./zlib-1.3.tar.gz" "./zlib-1.3" "./zlib" "./tor-tor-0.4.8.7.zip" "./tor-tor-0.4.8.7" "./tor" "./libzip-1.10.1.tar.gz" "./libzip-1.10.1" "./libzip" "./v2.0.3.zip" "./CRoaring-2.0.3" "./croaring" "./MWC-Validation-Node-master" "./node" "./v1.8.0.zip" "./QR-Code-generator-1.8.0" "./qrcodegen" "./libpng-1.6.40.tar.gz" "./libpng-1.6.40" "./libpng"
...
dependencies:
	...
	mv "./sqlite-autoconf-3430100" "./sqlite"
	cd "./sqlite" && "./configure" --prefix="$(CURDIR)/sqlite/dist" --disable-debug --disable-shared && make && make install
	
	# Simdjson
	wget "https://github.com/simdjson/simdjson/archive/refs/tags/v3.3.0.zip"
	unzip "./v3.3.0.zip"
	rm "./v3.3.0.zip"
	mv "./simdjson-3.3.0" "./simdjson"
	...
	# CRoaring
	wget "https://github.com/RoaringBitmap/CRoaring/archive/refs/tags/v2.0.3.zip"
	unzip "./v2.0.3.zip"
	rm "./v2.0.3.zip"
	...
	# Libpng
	wget "http://prdownloads.sourceforge.net/libpng/libpng-1.6.40.tar.gz"
	tar -xf "./libpng-1.6.40.tar.gz"
	rm "./libpng-1.6.40.tar.gz"
